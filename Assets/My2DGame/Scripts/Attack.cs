...
{
    /// <summary>
    /// HitBox에 부착되어 Damageable 충돌체에게 데미지는 클래스
    /// </summary>
    public class Attack : MonoBehaviour
    {
        ...
        //공격 효과 처리
        public GameObject damageEffecPrefab;
        #endregion
        ...
        private void OnTriggerEnter2D(Collider2D collision)
        {
            ...
            if (damageable != null)
            {
                ...
                if (damageEffecPrefab != null)
                {
                    GameObject effectGo = Instantiate(damageEffecPrefab, transform.position, Quaternion.identity);
                    Destroy(effectGo, 1f);
                }
            }
        }
